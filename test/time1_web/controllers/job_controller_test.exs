defmodule Time1Web.JobControllerTest do
  ...
  @create_attrs %{budget: 42, desc: "some desc", job_id: 42, name: "some name"}
  @update_attrs %{budget: 43, desc: "some updated desc", job_id: 43, name: "some updated name"}
  @invalid_attrs %{budget: nil, desc: nil, job_id: nil, name: nil}
